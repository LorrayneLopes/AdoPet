...
export class GenericAnimalModalComponent implements OnInit {
  ...
  constructor() {
    this.petForm = this.fb.group({
      ...
      size: ['MedioPorte', Validators.required],
      gender: ['Macho', Validators.required],
      specie: ['Gato', Validators.required],
      temperament: ['Docil', Validators.required],
      sociability: ['Gatos', Validators.required],
      liveWellWith: ['Apartamento', Validators.required],
      veterinaryCare: ['PrecisaDeCuidadosEspeciais', Validators.required],
